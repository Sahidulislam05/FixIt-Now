...
// ============================================================
// ব্যাকএন্ডের globalErrorHandler এর { success:false, message, errorDetails }
// শেপ অনুযায়ী একটা একই রকম ApiError সব জায়গায় থ্রো হয়, যাতে
// TanStack Query / react-hook-form / toast সবাই একই শেপ থেকে
// এরর মেসেজ ও field-level issues বের করতে পারে।
// ============================================================
...
// ============================================================
// অ্যাক্সেস টোকেন এক্সপায়ার/ইনভ্যালিড হলে (401) — সেশন ক্লিয়ার করে
// লগইন পেজে পাঠিয়ে দেওয়া হয়, যাতে ইউজার একটা বাজে জেনেরিক এরর টোস্ট
// দেখার বদলে সরাসরি বুঝতে পারে আবার লগইন করতে হবে। একাধিক রিকোয়েস্ট
// একসাথে 401 পেলে যেন বারবার redirect/toast না ঘটে, সেজন্য module-level
// গার্ড রাখা হয়েছে।
// ============================================================
...
export async function apiRequest<T>(path: string, options: RequestOptions = {}): Promise<T> {
    ...
    if (!response.ok) {
        const message: string = json?.message || "Something went wrong. Please try again.";
